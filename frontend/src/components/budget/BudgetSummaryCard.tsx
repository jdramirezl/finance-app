...
const BudgetSummaryCard = ({
    ...
    return (
        <div className="space-y-4">
            <Card padding="md" className="bg-gray-800 border border-gray-700 space-y-4">
                <div className="flex items-center justify-between">
                    <span className="text-gray-400 font-medium">Initial Amount:</span>
                ...
                <div className="space-y-2">
                    <div className="flex items-center justify-between">
                        <span className="text-gray-400 font-medium">Fixed Expenses:</span>
            ...
            {isSafe && remaining > 0 && (
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#06b6d4]/80 to-[#22d3ee]/80 p-[2px] shadow-xl shadow-[#06b6d4]/20">
                    <div className="relative h-full rounded-2xl bg-gray-800 p-6">
                        {/* Glowing orbs */}
                        ...
                        <div className="relative z-10 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                <div className="p-3 bg-gray-600 rounded-xl border border-gray-700">
            ...
            {!isSafe && (
                <Card padding="md" className="bg-[#93000a]/20 border-2 border-[#ffb4ab]/30">
                    <div className="flex items-center justify-between">
                        <span className="text-red-400 font-bold text-lg">⚠️ Over Budget:</span>
