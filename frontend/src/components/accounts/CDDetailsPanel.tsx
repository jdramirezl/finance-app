...
interface CDDetailsPanelProps {
  ...
  onRelease?: (account: CDInvestmentAccount) => void;
}

const CDDetailsPanel = ({ account, onEdit, onRelease }: CDDetailsPanelProps) => {
  ...
  return (
    <div className="space-y-4">
      ...
      {calculation && calculation.isMatured && (
        <div className="flex items-center justify-between gap-3 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
          <div className="flex items-center gap-3">
